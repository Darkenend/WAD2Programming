...
*
* "Los biorritmos constituyen un intento de predecir aspectos diversos de la vida de un individuo
* recurriendo a ciclos matemáticos sencillos. La mayoría de los investigadores estima que esta
* idea no tendría más poder predictivo que el que podría atribuirse al propio azar,
* considerándola un caso claro de pseudociencia" (Wikipedia)
*
* USO
* ---
* Constructor: Toma dos argumentos; la fecha de nacimiento y la fecha para la cual se quiere
* calcular el bioritmo. Si esta segunda fecha no se define, se toma la fecha de hoy:
*
* $test = new BioRitmo('1971-05-15', '2004-08-06');
*
* DrawBior: Construye el diagrama, lo escribe en el disco en el lugar especificado por su
* argumento. Usa path relativos
*
...
*/
// Parametrización
define('PHY_PERIOD',33);
define('EMO_PERIOD',28);
define('INT_PERIOD',23);

// number of days on diagram
...
// define colors for diagram / RGB format
define('BACK_C_R', 219);
define('BACK_C_G', 219);
define('BACK_C_B', 219);
define('GRID_C_R', 0);
...
define('INT_C_G',0);
define('INT_C_B',112);
// end customization; do not edit below this line
...
class Bioritmos {
    ...
    // Get percentage for given day for given curve
    ...
    private function GetAverage () {
        ...
        if ($phy['trend'] + $emo['trend'] + $int['trend'] >= 2)
            ...
            $avg_trend = 0;
        return array ('percent' => ceil(($phy['percent'] + $emo['percent'] + $int['percent']) / 3), 'trend' => $avg_trend);
    }
